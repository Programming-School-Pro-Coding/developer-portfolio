...
const openSource = {
  githubConvertedToken: "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",
...
fetch(baseUrl, {
  ...
  .then((txt) => {
    ...
    fs.writeFile(
      "./src/components/Projects/github_data/pull_requests.json",
...
fetch(baseUrl, {
  ...
  .then((txt) => {
    ...
    fs.writeFile(
      "./src/components/Projects/github_data/issues.json",
      JSON.stringify(cropped),
      function (err) {
        if (err) {
          console.log(err);
...
fetch(baseUrl, {
  ...
  .then((txt) => {
    ...
    fs.writeFile(
      "./src/components/Projects/github_data/organizations.json",
...
fetch(baseUrl, {
  ...
  .then((txt) => {
    ...
    fs.writeFile(
      "./src/components/Projects/github_data/projects.json",
...
fetch(baseUrl, {
  ...
  .then((txt) => {
    ...
    for (var i = 0; i < repositories.length; i++) {
      ...
      obj["languages"] = newLangobjs;
      newRepositories["data"].push(obj);
    }

    console.log("Fetching the Repositories Data.\n");
    fs.writeFile(
      "./src/components/Projects/github_data/repositories.json",
      JSON.stringify(newRepositories),
      function (err) {
        if (err) {
          console.log("Error occured in Repositories 3", JSON.stringify(err));
        }
      }
    );
  })
  .catch((error) =>
    console.log("Error occured in Repositories 3", JSON.stringify(error))
  );
