...
function SingleProject({ repo, theme }) {
        ...
        <Fade bottom duration={2000} distance="40px">
          ...
          >
            <div className="repo-name-div">
              ...
              <p className="repo-name" style={{ color: theme.tertiary }}>
                {repo.name}
              </p>
            </div>
            <p className="repo-description" style={{ color: theme.tertiary }}>
              {repo.description === null ? repo.description : "No Description"}
            </p>
            <div className="repo-details">
              <p
                className="repo-creation-date subTitle"
                style={{ color: theme.MyColor }}
              >
